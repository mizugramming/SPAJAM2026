...
- [AGENTS.md](AGENTS.md)：共通の開発ルール。
- [担当作業の開始・再開プロンプト](docs/ai_prompts.md)：そのままAIへ渡せます。
- [別プロジェクトへのコピー手順](docs/reuse_rules.md)：共通ファイルとアプリ固有の情報の分け方。

以下はこのリポジトリのアプリ固有の手順です。別のアプリでは、そのアプリのREADMEと設計書を用意してください。
